# Around-the-World-REACT.js
Created an React.Js application, which fetches EPL 2015-16 and 2016-17 data from an api

## Screenshots

### Home

![Alt text](https://github.com/laffingDragons/Screenshots/blob/master/18.PNG?raw=true "Title")

### All Countries

![Alt text](https://github.com/laffingDragons/Screenshots/blob/master/19.PNG?raw=true "Title")

### Single Country

![Alt text](https://github.com/laffingDragons/Screenshots/blob/master/20.PNG?raw=true "Title")
...
All `expect()` matchers supported by Jest are [ex
